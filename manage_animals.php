                        ...
                        if(mysqli_num_rows($query_run) > 0) 
                        {
                            foreach($query_run as $animal)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="animaledit.php?id=<?$animal['animal_id'];?>" class="btn btn-success btn-sm">Edit</a> 
                                        <!-- <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_animal" value="<?=$animal['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                          -->
                                          <a href="animaldelete.php?id=<?=$animal['animal_id'];?>" class="btn btn-danger btn-sm">DELETE</a>
